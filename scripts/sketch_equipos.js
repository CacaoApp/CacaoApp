window.addEventListener('load',function() {
    ...
    let cacaosCoate = 0;
    let cacaosHuitzilin = 0;
    let cacaosMazate = 0;
    let cacaosMichin = 0;
    let refEquipos = firebase.database().ref('grupos');
    ...
    let estudiantesMazate = [];
    let estudiantesCoate = [];
    let estudiantesMichin = [];
    let estudiantesHuitzilin = [];
    
    let refEstudiantes = firebase.database().ref('estudiantes');
